...
class BannerVendedor(FloatLayout):
    def __init__(self, **kwargs):
        ...
        link = f'https://appvendashash-b902a-default-rtdb.firebaseio.com/.json?orderBy="id_vendedor"&equalTo="{id_vendedor}"'
        ...
        label_vendas = LabelButton(text=f"ID Vendedor: {id_vendedor}",
                                   pos_hint={"right": 0.9, "top": 0.8}, size_hint=(0.5, 0.5),
                                   on_release=partial(meu_aplicativo.carregar_vendas_vendedor,valor))
